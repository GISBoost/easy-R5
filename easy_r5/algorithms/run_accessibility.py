...
class RunAccessibility(MatrixBase, QgsProcessingAlgorithm):
    ...
    def shortHelpString(self) -> str:  # noqa: N802
        return self.tr(
            ...
            "STEP decay (count everything strictly under the cutoff — a trip of "
            "exactly the cutoff length does not count) is the default and what "
            "accessibility studies use; LOGISTIC and EXPONENTIAL taper.\n\n"
