...
| [`demo_v03_lodz/`](demo_v03_lodz/README.md) | **Worked example of the 0.3.0 algorithms** on Łódź, plugin-only: GTFS pre-flight check, a scenario tram line chosen from the data (the most populated hex with zero schools within 30 min), before/after comparison on hexes, 2SFCA school supply per 1000 residents, and population-weighted equity summaries. Step-by-step README, QGIS project grouped per stage. |
