...
| [`realtime_delay_lodz/`](realtime_delay_lodz/README.md) | Where GTFS-RT delays hurt reachability the most: `RunAccessibility` on the static vs. realized-P50 schedule for the same real day, entirely on Easy-R5's own algorithms (no R/r5r, no Overpass at runtime). |
